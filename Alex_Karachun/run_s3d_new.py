...
if __name__ == "__main__":
    res = make_predictions_from_video_7_frames(
        ...
        model_dir='Alex_Karachun/trained_models/s3d_1000_gestures_100_videos_10_epochs_done_7_frames/s3d_1000_gestures_100_videos_3_epoch'
    )
...
['no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'меня', 'меня', 'меня', 'меня', 'меня', 'меня', 'меня', 'имя', 'меня', 'меня', 'меня', 'меня', 'меня', 'меня', 'меня', 'меня', 'меня', 'меня', 'белый', 'меня', 'жуткий', 'жуткий', 'открыть', 'дать', 'дать', 'дать', 'дать', 'дать', 'дать', 'дать', 'дать', 'кроме', 'кроме', 'кроме', 'дом', 'дом', 'дом', 'дом', 'дом', 'дом', 'дом', 'дом', 'дом', 'дом', 'дом', 'дом', 'без', 'дом', 'без', 'без', 'без', 'без', 'без', 'без', 'дать', 'рад', 'рад', 'прийти', 'прийти', 'прийти', 'прийти', 'идти', 'идти', 'идти', 'идти', 'идти', 'идти', 'идти', 'неловкий; неуклюжий', 'идти', 'идти', 'идти', 'идти', 'идти', 'неловкий; неуклюжий', 'идти', 'идти', 'идти', 'идти', 'идти', 'идти', 'получить', 'получить', 'получить', 'получить', 'получить', 'получить', 'получить', 'получить', 'получить', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event', 'no_event'])
